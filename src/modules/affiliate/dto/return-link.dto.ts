...
export class ReturnLinkDto {
  @ApiProperty({
    ...
    description: 'Nội dung bài đăng chứa các link Shopee cũ cần thay thế',
  })
  @StringField()
  content: string;

  @ApiProperty({
    example: 'https://s.shopee.vn/newLink1\nhttps://s.shopee.vn/newLink2',
    description: 'Các link mới, mỗi link một dòng, theo thứ tự tương ứng',
  })
  @StringField()
  linksNew: string;
}
